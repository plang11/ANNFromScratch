...
parameters_testing <- two_layer_model(X, y, layers_dimensions, .0075, 100, TRUE)
...
and returns the probability vector of the labels 0-9 which should then be compared with the actual label vector *test_y*
...
#set this to any num between 0 and 42000 to see what the model predicts
num <- 16000

test_y <- y[,num]

prediction <- predict(X, num, parameters_testing)
